...
DOCUMENT_UNIT_PRICE = 4500      # 資料1件あたりの売上単価
...
if spreadsheet_id:
    try:
        ...
        if not df_all.empty:
            ...
            # 月フィルター（最新の月が一番上にくるように並び替えてデフォルト選択）
        ...
        with tab1:
            ...
            with st.expander("🔒 【管理者専用】売上・人件費・利益の確認"):
                ...
                if input_pass == ADMIN_PASSWORD:
                    # 個人タブで入力された稼働時間をもとに計算（セッション状態参照）
                    total_cost = 0
...
"""
                    ...
                    st.markdown(f"#### 📄 {selected_month} の架電履歴")
